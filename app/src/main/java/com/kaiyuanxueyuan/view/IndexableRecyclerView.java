...
import com.kaiyuanxueyuan.contacts.IndexableRecyclerViewAdapter;
import com.kaiyuanxueyuan.contacts.SectionedRecyclerAdapter;
/**
 * Author: seewhy
 * Date: 2016/1/14
 */
public class IndexableRecyclerView extends RelativeLayout {
    ...
    private void initViews(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.contacts_recyclerview_indexable, this);
    ...
    public void setAdapter(IndexableRecyclerViewAdapter adapter) {
        mRecyclerAdapter = new SectionedRecyclerAdapter(mContext, R.layout.contacts_title_item, R.id.tvName, adapter);
