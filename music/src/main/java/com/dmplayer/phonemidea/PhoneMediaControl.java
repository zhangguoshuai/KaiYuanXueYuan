...
//                sortOrder = MediaStore.Audio.Media.DATE_ADDED + " desc";
            ...
            case Album:
                String wherecls = MediaStore.Audio.Media.ALBUM + "=" + id + " AND " + MediaStore.Audio.Media.IS_MUSIC + "=1";
                sortOrder = MediaStore.Audio.Media.DEFAULT_SORT_ORDER;
        ...
        try {
            if (cursor != null && cursor.getCount() >= 1) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    long album_id = cursor.getLong(cursor.getColumnIndex(FavoritePlayTableHelper.ALBUM));
    ...
    public PhoneMediaControlINterface phonemediacontrolinterface;

    public  PhoneMediaControlINterface getPhonemediacontrolinterface() {
        return phonemediacontrolinterface;
    }

    public void setPhonemediacontrolinterface(PhoneMediaControlINterface phonemediacontrol) {
        phonemediacontrolinterface = phonemediacontrol;
    }
