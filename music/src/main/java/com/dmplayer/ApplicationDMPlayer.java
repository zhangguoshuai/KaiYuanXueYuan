...
public class ApplicationDMPlayer{
    ...
    public static ApplicationDMPlayer applicationDMPlayer;

    public static void getInstances(Context context){
        applicationContext = context;
        applicationDMPlayer = new ApplicationDMPlayer();
        applicationDMPlayer.onCreate();
    }
    ...
    public static ApplicationDMPlayer getApplicationContext(){
        return applicationDMPlayer;
    }
...
//                        displaySize.set(size.x, size.y);
    ...
    private void initilizeDB() {
        if (DB_HELPER == null) {
            DB_HELPER = new DMPLayerDBHelper(applicationContext);
        }
        try {
