...
public class StudyAdapter extends RecyclerView.Adapter<StudyAdapter.ViewHolder>{
    ...
    public StudyAdapter(Context context, ArrayList<String> name,ArrayList<Integer> icon) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View view = View.inflate(viewGroup.getContext(), R.layout.study_list_item, null);
        // 创建一个ViewHolder
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view) {
            super(view);
            itemview = view;
            name = (TextView) view.findViewById(R.id.study_name);
            icon = (ImageView) view.findViewById(R.id.study_icon);
        }
    }
}
