...
public class MainListAdapter extends RecyclerView.Adapter<MainListAdapter.ViewHolder>{
    ...
    public MainListAdapter(Context context, ArrayList<Integer> logoList, ArrayList<String> titleList, ArrayList<String> personNumberList, ArrayList<String> statusList ) {
        super();
