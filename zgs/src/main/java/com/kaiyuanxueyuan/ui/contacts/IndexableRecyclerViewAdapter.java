package com.kaiyuanxueyuan.ui.contacts;
...
public class IndexableRecyclerViewAdapter extends RecyclerView.Adapter implements SectionedRecyclerAdapter.SectionedRecyclerDelegate {
    ...
    public IndexableRecyclerViewAdapter(Activity activity, List<ItemModel> models) {
        mItemModels = models;
    ...
    private void init() {
        mSectionedHashMap = new LinkedHashMap<String, List<ItemModel>>();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new BannerViewHolder(mLayoutInflater.inflate(R.layout.contacts_recycler_item, parent, false));
    }
